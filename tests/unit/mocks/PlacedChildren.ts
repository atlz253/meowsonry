...
export function getThreeRowsBoxesPlacedChildren() {
  return [
    ...
    { top: 10, left: 20, width: 10, height: 10, remainingRawWidth: 0 },
    { top: 20, left: 0, width: 10, height: 10, remainingRawWidth: 20 },
    { top: 20, left: 10, width: 10, height: 10, remainingRawWidth: 10 },
    { top: 20, left: 20, width: 10, height: 10, remainingRawWidth: 0 },
